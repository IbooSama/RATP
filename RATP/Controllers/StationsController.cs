...
namespace RATP.Controllers
{
    public class StationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Latitude,Longitude,LineID,Number")] Station station)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Latitude,Longitude,LineID,Number")] Station station)
        {
            if (id != station.ID)
            {
                return NotFound();
